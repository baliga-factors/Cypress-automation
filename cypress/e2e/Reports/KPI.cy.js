...
describe('Reports -> KPI', () => {  

    it('Create and Save KPI query', () => {
        ...
        // cy.get('.fa--query_block:nth-child(1) .ant-collapse-content > .ant-collapse-content-box > :nth-child(1) > .undefined > .QueryBlock_query_block__event__2Psl5 > .ant-btn').should('be.visible').click();
